...
// WP-Optimize advanced-cache.php (written by version: 3.0.19) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/home/q/q95608mp/bizov.com.ua/public_html/wp-content/plugins/wp-optimize/cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/q/q95608mp/bizov.com.ua/public_html/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-bizov.com.ua.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-bizov.com.ua.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-bizov.com.ua.php');
}
