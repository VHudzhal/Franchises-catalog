...
get_header(); ?>
<div id="business-products-3" class="business-content-area">
    <?php get_sidebar('left-main');?>
    <main id="prod-3-main" class="business-products-main" role="main">
...
//        wp_nav_menu(array(
//            'container'       => 'div',
//            'theme_location'  => 'category-bez-3',
//            'menu_id'         => 'product-cat-menu-3',
//            'menu_class'	  => 'product-cat-link',
//            'depth'           => 1,
//        ) );
        // tutsplus_product_subcategories('cat=22&order=asc')
